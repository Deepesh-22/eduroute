...
/** Build a structured prompt for Buddy / local AI summary from filled CV fields */
function buildSummaryPrompt(data: CvData, skills: string[]): string {
...
/** Local fallback when Buddy API is offline — compose from filled fields */
function localAiSummary(data: CvData, skills: string[]): string {
...
function TemplateThumb({ id }: { id: CvTemplateId }) {
  if (id === 'professional') {
    return (
      <div className="flex h-32 w-40 overflow-hidden rounded border border-slate-300 bg-white shadow-sm dark:border-slate-600">
        <div className="flex w-[38%] flex-col items-center bg-[#1e3a4c] px-1.5 py-2 text-center">
          <div className="mb-1 flex h-7 w-7 items-center justify-center rounded-full bg-[#2d4f63] text-[10px]">👤</div>
          <div className="text-[7px] font-bold leading-tight text-white">Brian T.</div>
          <div className="mt-0.5 text-[5px] text-[#a8c0ce]">Wayne</div>
          <div className="mt-1.5 w-full space-y-0.5">
            <div className="h-1 w-full rounded bg-[#2d4f63]" />
            <div className="h-1 w-4/5 rounded bg-[#2d4f63]" />
            <div className="mt-1 h-1.5 w-full rounded bg-[#2d4f63]" />
            <div className="h-1 w-full rounded bg-[#2d4f63]/50" />
            <div className="h-1 w-3/4 rounded bg-[#2d4f63]/50" />
          </div>
        </div>
        <div className="flex-1 space-y-1 bg-white p-1.5">
          <div className="rounded bg-slate-100 px-1 py-0.5 text-[5px] font-bold uppercase text-slate-600">Work Experience</div>
          <div className="h-1 w-full rounded bg-slate-200" />
          <div className="h-1 w-5/6 rounded bg-slate-100" />
          <div className="h-1 w-4/5 rounded bg-slate-100" />
          <div className="mt-1 rounded bg-slate-100 px-1 py-0.5 text-[5px] font-bold uppercase text-slate-600">Education</div>
          <div className="h-1 w-full rounded bg-slate-200" />
          <div className="h-1 w-3/4 rounded bg-slate-100" />
          <div className="mt-1 rounded bg-slate-100 px-1 py-0.5 text-[5px] font-bold uppercase text-slate-600">Skills</div>
          <div className="flex flex-wrap gap-0.5">
            <span className="h-1.5 w-6 rounded bg-slate-200" />
            <span className="h-1.5 w-5 rounded bg-slate-200" />
  ...
  if (id === 'classic') {
    return (
      <div className="flex h-32 w-36 flex-col overflow-hidden rounded border border-slate-300 bg-white px-2 py-1.5 shadow-sm dark:border-slate-600">
        <div className="text-center">
          <div className="text-[9px] font-bold tracking-tight text-slate-900">Emily Carter</div>
          <div className="text-[6px] italic text-slate-500">Project Manager</div>
          <div className="mt-0.5 flex justify-center gap-1 text-[5px] text-slate-400">
            <span>📍 City</span><span>✉ mail</span><span>📞 phone</span>
          </div>
        </div>
        <div className="mt-1.5 border-b border-slate-800 text-[6px] font-bold uppercase tracking-wide text-slate-800">Summary</div>
        <div className="mt-0.5 space-y-0.5">
          <div className="h-1 w-full rounded bg-slate-200" />
          <div className="h-1 w-11/12 rounded bg-slate-100" />
        </div>
        <div className="mt-1.5 border-b border-slate-800 text-[6px] font-bold uppercase tracking-wide text-slate-800">Experience</div>
        ...
        <div className="h-1 w-5/6 rounded bg-slate-100" />
        <div className="mt-1 border-b border-slate-800 text-[6px] font-bold uppercase tracking-wide text-slate-800">Skills</div>
        <div className="mt-0.5 grid grid-cols-2 gap-0.5">
          <div className="h-1 rounded bg-slate-200" /><div className="h-1 rounded bg-slate-200" />
          <div className="h-1 rounded bg-slate-100" /><div className="h-1 rounded bg-slate-100" />
        </div>
      </div>
    );
  }
  if (id === 'modern') {
    return (
      <div className="flex h-32 w-36 flex-col overflow-hidden rounded border border-slate-300 bg-white shadow-sm dark:border-slate-600">
        <div className="h-1.5 w-full bg-indigo-600" />
        <div className="flex-1 px-2 py-1.5">
          <div className="text-[9px] font-black text-indigo-600">Alex Rivera</div>
          <div className="text-[6px] font-semibold text-slate-500">Software Engineer</div>
          <div className="mt-0.5 text-[5px] text-slate-400">email · phone · city</div>
          <div className="mt-1.5 border-b-2 border-indigo-600 text-[6px] font-bold uppercase text-indigo-600">Skills</div>
          <div className="mt-0.5 h-1 w-full rounded bg-slate-200" />
          <div className="mt-1.5 border-b-2 border-indigo-600 text-[6px] font-bold uppercase text-indigo-600">Experience</div>
          <div className="mt-0.5 h-1.5 w-20 rounded bg-slate-300" />
          <div className="mt-0.5 h-1 w-full rounded bg-slate-100" />
          <div className="h-1 w-4/5 rounded bg-slate-100" />
          <div className="mt-1 border-b-2 border-indigo-600 text-[6px] font-bold uppercase text-indigo-600">Education</div>
          <div className="mt-0.5 h-1 w-16 rounded bg-slate-200" />
        </div>
      </div>
    );
  }
  return (
    <div className="flex h-32 w-36 flex-col overflow-hidden rounded border border-slate-200 bg-white px-2.5 py-2 shadow-sm dark:border-slate-600">
      <div className="text-[9px] font-semibold tracking-wide text-slate-800">Jordan Lee</div>
      <div className="text-[6px] text-slate-400">Product Designer</div>
      <div className="mt-0.5 text-[5px] text-slate-300">city · email</div>
      <div className="mt-2 space-y-1">
        <div className="h-1 w-full rounded bg-slate-100" />
        <div className="h-1 w-5/6 rounded bg-slate-50" />
        <div className="mt-1.5 h-1 w-10 rounded bg-slate-300" />
        <div className="h-1 w-full rounded bg-slate-100" />
        <div className="h-1 w-4/5 rounded bg-slate-50" />
        <div className="mt-1.5 h-1 w-10 rounded bg-slate-300" />
        <div className="h-1 w-3/4 rounded bg-slate-100" />
      </div>
    </div>
...
export const CvBuilder = () => {
  ...
  const handleAiWriteSummary = async () => {
    ...
    applyCerts();
    applyLangs();
    const skills = parseList(skillsText).length ? parseList(skillsText) : data.skills || [];
    const snapshot: CvData = {
      ...data,
      skills,
      certificates: parseList(certsText).length ? parseList(certsText) : data.certificates || [],
      languages: parseList(langsText).length ? parseList(langsText) : data.languages || [],
    };
    const prompt = buildSummaryPrompt(snapshot, skills);
    try {
      const auth = getAuthUser();
      const userId = auth?.id || auth?.email || 'cv-builder-student';
      const res = await sendBuddyMessage({
        userId: String(userId),
        message: prompt,
        language: 'english',
        context: { missingSkills: skills.slice(0, 8) },
      });
      ...
      if (
        !reply ||
        reply.length < 40 ||
        /limited mode|Beginner → Intermediate|Weekly challenge/i.test(reply)
      ) {
        reply = localAiSummary(snapshot, skills);
      }
      if (reply.length > 700) reply = reply.slice(0, 697) + '…';
      update({ summary: reply });
    } catch {
      const fallback = localAiSummary(snapshot, skills);
      update({ summary: fallback });
      setAiError('AI service offline — generated from your filled CV fields.');
    } finally {
      setAiWriting(false);
    }
  };
    ...
    return (
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">Preview shows how your CV will look — Classic = Emily · Professional = Brian</p>
        </div>
        <div className="grid gap-5 sm:grid-cols-2">
          {CV_TEMPLATES.map((t) => (
            ...
            >
              <div className="mb-3 flex h-36 items-center justify-center overflow-hidden rounded-xl bg-gradient-to-b from-slate-100 to-slate-50 p-2 dark:from-slate-800 dark:to-slate-900">
              ...
              <div className="mt-2 flex flex-wrap gap-1">
                {t.tags.map((tag) => (
                  <span key={tag} className="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-semibold text-slate-600 dark:bg-slate-800 dark:text-slate-300">{tag}</span>
                ))}
              </div>
            </button>
          ))}
        ...
        <div className="mt-8 text-center">
          ...
          >
            Continue with {CV_TEMPLATES.find((t) => t.id === data.template)?.name || 'Classic'} <Sparkles className="h-4 w-4" />
          </button>
        </div>
      </div>
    );
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        ...
        <button type="button" onClick={handleDownloadPdf} className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-bold text-white shadow-md hover:bg-indigo-500">
        ...
        <nav className="lg:col-span-2">
          <ul className="sticky top-20 space-y-1">
            {SECTIONS.map((s) => {
              ...
              return (
                <li key={s.id}>
                  <button type="button" onClick={() => setSection(s.id)} className={`flex w-full items-center gap-2 rounded-xl px-3 py-2.5 text-left text-xs font-bold ${section === s.id ? 'bg-indigo-600 text-white' : 'text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800'}`}>
          ...
          {section === 'contact' && (
            <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-900">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {([['fullName', 'Full name'], ['title', 'Target role / title'], ['email', 'Email'], ['phone', 'Phone'], ['city', 'City / location'], ['linkedin', 'LinkedIn URL or handle']] as const).map(([k, l]) => (
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-900">
              <div className="flex flex-wrap items-start justify-between gap-2">
                <div>
                  ...
                  <p className="mt-0.5 text-[11px] text-slate-500">Fill Experience, Education & Skills first — AI uses that data to write your summary.</p>
                </div>
                <div className="flex flex-wrap gap-2">
                  <button
                    type="button"
                    onClick={() => update({ summary: SAMPLE_SUMMARIES[Math.floor(Math.random() * SAMPLE_SUMMARIES.length)] })}
                    className="inline-flex items-center gap-1 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-[11px] font-bold text-slate-600 hover:border-indigo-300 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-300"
                  >
                    Sample
                  </button>
                  <button
                    type="button"
                    disabled={aiWriting}
                    onClick={() => void handleAiWriteSummary()}
                    className="inline-flex items-center gap-1.5 rounded-xl border border-indigo-200 bg-indigo-50 px-3 py-1.5 text-[11px] font-bold text-indigo-700 disabled:opacity-60 dark:border-indigo-800 dark:bg-indigo-950/40 dark:text-indigo-300"
                  >
                    <Wand2 className={`h-3.5 w-3.5 ${aiWriting ? 'animate-spin' : ''}`} />
              ...
              <textarea
                ...
                placeholder="2–5 professional lines… or click AI Write after filling other sections"
              />
              {aiError && <p className="mt-2 text-[11px] font-medium text-amber-600 dark:text-amber-400">{aiError}</p>}
              <p className="mt-2 text-[10px] text-slate-400">AI Write sends your role, experience, education, skills & projects to Buddy in the same format as AI Buddy chat, then pastes the reply here.</p>
            </section>
          )}
          {section === 'skills' && (
            <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-900">
              ...
              <div className="mt-4 space-y-4">
                {data.education.map((edu, idx) => (
                  <div key={edu.id} className="rounded-xl border border-slate-100 p-3 dark:border-slate-800">
                    <div className="mb-2 flex justify-end">{data.education.length > 1 && (<button type="button" onClick={() => update({ education: data.education.filter((_, i) => i !== idx) })} className="text-slate-400 hover:text-rose-500"><Trash2 className="h-3.5 w-3.5" /></button>)}</div>
              ...
              <div className="mt-4 space-y-4">
                {data.experience.map((exp, idx) => (
                  <div key={exp.id} className="rounded-xl border border-slate-100 p-3 dark:border-slate-800">
                    <div className="mb-2 flex justify-end">{data.experience.length > 1 && (<button type="button" onClick={() => update({ experience: data.experience.filter((_, i) => i !== idx) })} className="text-slate-400 hover:text-rose-500"><Trash2 className="h-3.5 w-3.5" /></button>)}</div>
                    <div className="grid gap-2 sm:grid-cols-2">
              ...
              <div className="mt-4 space-y-4">
                {data.projects.map((p, idx) => (
                  <div key={p.id} className="rounded-xl border border-slate-100 p-3 dark:border-slate-800">
                    <div className="mb-2 flex justify-end">{data.projects.length > 1 && (<button type="button" onClick={() => update({ projects: data.projects.filter((_, i) => i !== idx) })} className="text-slate-400 hover:text-rose-500"><Trash2 className="h-3.5 w-3.5" /></button>)}</div>
                    <div className="grid gap-2 sm:grid-cols-2">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {(Object.keys(ACCENT_COLORS) as CvAccentId[]).map((id) => (
                  <button key={id} type="button" onClick={() => update({ accent: id })} className={`flex items-center gap-2 rounded-xl border px-3 py-2 text-xs font-bold ${data.accent === id ? 'border-indigo-500 ring-2 ring-indigo-500/30' : 'border-slate-200 dark:border-slate-700'}`}>
                    <span className="h-4 w-4 rounded-full" style={{ background: ACCENT_COLORS[id].hex }} />{ACCENT_COLORS[id].label}
                  </button>
                ))}
              </div>
