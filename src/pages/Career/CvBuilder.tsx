...
function openPrintPreview(data: CvData) {
  ...
  // Reliable print: hidden iframe (avoids popup blockers + noopener document.write issues)
...
/** Mini visual mock of each template so students see the layout at a glance */
