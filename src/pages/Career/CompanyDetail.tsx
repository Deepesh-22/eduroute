        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8 h-full flex items-end pb-8">
           ...
           <div className="flex flex-col md:flex-row items-end gap-6 w-full">
              <div className="h-24 w-24 md:h-32 md:w-32 bg-white rounded-[32px] p-1 shadow-2xl flex items-center justify-center overflow-hidden">
                 <img src={internship.logo} alt={internship.company} className="w-full h-full object-cover rounded-[28px]" />
              </div>
              <div className="flex-1 text-center md:text-left">
                 ...
                 <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-4 text-white/70 text-sm font-bold">
                    <span className="flex items-center gap-2"><MapPin className="h-4 w-4 text-indigo-400" /> {internship.location}</span>
                    <span className="flex items-center gap-2"><Users className="h-4 w-4 text-indigo-400" /> {internship.employeeCount}</span>
                    <span className="flex items-center gap-2"><Globe className="h-4 w-4 text-indigo-400" /> <a href={internship.companylink} target="_blank" rel="noopener noreferrer" className="hover:underline">{internship.companylink}</a></span>
                 </div>
              </div>
         ...
         <div className="lg:col-span-2 space-y-12">
            <section>
               ...
               <p className="text-slate-600 leading-relaxed text-lg">
                  {internship.company} is a leading AI-first engineering company building next-generation cloud infrastructure. 
            ...
            <section>
               ...
               <div className="space-y-4">
                  <div className="p-6 bg-white rounded-3xl border border-slate-100 flex items-center justify-between group hover:border-indigo-100 transition-all">
                       <div>
                          <h4 className="font-bold text-slate-900">{internship.role}</h4>
                          <p className="text-sm text-slate-500 font-medium mt-1">Stipend: {internship.stipend} • {internship.duration}</p>
                       </div>
